...
/// routing.py.
pub const MIN_TURN_ANGLE_DEG: f32 = 45.0;
...
pub fn bearing(from_lon: f32, from_lat: f32, to_lon: f32, to_lat: f32) -> f32 {
    (to_lon - from_lon).atan2(to_lat - from_lat)
}

/// Unsigned turn angle in degrees between two bearings.
/// 0 = straight ahead, 180 = U-turn.
pub fn turn_angle_deg(bearing_in: f32, bearing_out: f32) -> f32 {
...
pub fn is_left_turn(bearing_in: f32, bearing_out: f32) -> bool {
