...
create table if not exists raw_data.addresses (
...
create table if not exists raw_data.businesses (
...
create table if not exists raw_data.trading_partnership (
...
alter table marts.addresses
alter column ingested_to_postgres drop default;

alter table marts.businesses
alter column ingested_to_postgres drop default;

alter table marts.trading_partnership
alter column ingested_to_postgres drop default;
