...
#     # Generate a dbt model using the mapper + generator together:
#     gen = DbtModelGenerator("/path/to/dbt")
#     mapper.write_dbt_model(spec, vintage=2022, dbt_generator=gen)
# """
...
# from loci.transform.model_generator import DbtModelGenerator
...
#         Suitable for passing as column_mapping to DbtModelGenerator.
#         """
#         df = self.build_mapping_df(spec, vintage)
#         return dict(zip(df["variable"], df["column_name"]))
...
#         spec: CensusDatasetSpec,
#         vintage: int,
#         dbt_generator: DbtModelGenerator,
#     ) -> Path:
#         """
#         Generate a dbt staging model for a census dataset spec.

#         Delegates file writing and sources.yml management to the
#         DbtModelGenerator. Geography columns and vintage are passed
#         through without aliasing; variable columns are aliased via
#         the compressed column map.

#         Args:
#             spec: The census dataset specification.
#             vintage: The vintage to resolve variable metadata for.
#             dbt_generator: A DbtModelGenerator instance pointed at the
...
#         return dbt_generator.generate_loading_model(
...
#     ) -> Path:
#         """
#         Convenience alias for generate_dbt_model().

#         Kept for backwards compatibility. Takes a DbtModelGenerator
#         instead of the old output_dir parameter.
#         """
#         return self.generate_dbt_model(spec, vintage, dbt_generator)
