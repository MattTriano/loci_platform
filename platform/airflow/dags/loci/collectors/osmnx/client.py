...
#             A little bit of tile overlap to ensure full collection.
...
#         for tile in tiles:
#             tile_id = self._make_tile_id(tile)  # still based on original grid
#             log.info("Processing tile %s", tile_id)

#             # Expand for download only
#             west, south, east, north = tile
#             download_bbox = (
#                 west - overlap_degrees,
#                 south - overlap_degrees,
#                 east + overlap_degrees,
#                 north + overlap_degrees,
#             )

#             try:
#                 G = self.get_bike_network(bbox=download_bbox, network_type=network_type)
#             except Exception as e:
#                 if "No data elements in server response" in str(e):
#                     log.info("Skipping tile %s — no data returned", tile_id)
#                     continue
#                 raise
