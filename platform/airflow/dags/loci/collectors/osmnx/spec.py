...
Usage:
    ...
    spec = OsmnxDatasetSpec(
        ...
        target_table_nodes="osmnx_chicago_bike_network_nodes",
        target_table_edges="osmnx_chicago_bike_network_edges",
...
class OsmnxDatasetSpec(DatasetSpec):
    ...
    target_table_nodes: str = "osmnx_chicago_bike_network_nodes"
    target_table_edges: str = "osmnx_chicago_bike_network_edges"
