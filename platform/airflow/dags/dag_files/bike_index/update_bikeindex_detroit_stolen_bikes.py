...
from loci.sources.update_configs import (
    BIKEINDEX_DETROIT_STOLEN_BIKES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["bikeindex", "detroit", "theft", "biking"],
)
def update_bikeindex_detroit_stolen_bikes():
...
update_bikeindex_detroit_stolen_bikes()
