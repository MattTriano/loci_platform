...
from loci.sources.update_configs import (
    BIKEINDEX_MADISON_STOLEN_BIKES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["bikeindex", "madison", "theft", "biking"],
)
def update_bikeindex_madison_stolen_bikes():
...
update_bikeindex_madison_stolen_bikes()
