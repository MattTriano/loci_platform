...
from loci.sources.update_configs import (
    BIKEINDEX_TORONTO_STOLEN_BIKES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["bikeindex", "toronto", "theft", "biking"],
)
def update_bikeindex_toronto_stolen_bikes():
...
update_bikeindex_toronto_stolen_bikes()
