...
from loci.sources.update_configs import (
    BIKEINDEX_DENVER_STOLEN_BIKES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["bikeindex", "denver", "theft", "biking"],
)
def update_bikeindex_denver_stolen_bikes():
...
update_bikeindex_denver_stolen_bikes()
