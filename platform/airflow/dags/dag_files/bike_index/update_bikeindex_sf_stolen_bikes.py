...
from loci.sources.update_configs import (
    BIKEINDEX_SAN_FRANCISCO_STOLEN_BIKES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["bikeindex", "san_francisco", "theft", "biking"],
)
def update_bikeindex_sf_stolen_bikes():
...
update_bikeindex_sf_stolen_bikes()
