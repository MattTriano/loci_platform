...
from loci.sources.update_configs import (
    COOK_COUNTY_PARCEL_ADDRESSES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["socrata", "update", "Cook County", "parcels", "addresses"],
)
def update_cook_county_parcel_addresses():
    update_socrata_table(update_config=UPDATE_CONFIG, conn_id=CONN_ID, task_logger=task_logger)


update_cook_county_parcel_addresses()
