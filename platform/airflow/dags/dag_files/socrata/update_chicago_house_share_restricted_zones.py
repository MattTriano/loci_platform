...
from loci.sources.update_configs import (
    CHICAGO_HOUSE_SHARE_RESTRICTED_ZONES_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["socrata", "update", "chicago", "boundary"],
)
def update_chicago_house_share_restricted_zones():
    update_socrata_table(update_config=UPDATE_CONFIG, conn_id=CONN_ID, task_logger=task_logger)


update_chicago_house_share_restricted_zones()
