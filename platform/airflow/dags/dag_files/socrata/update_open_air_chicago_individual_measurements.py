...
from loci.sources.update_configs import (
    OPEN_AIR_CHICAGO_INDIVIDUAL_MEASUREMENTS_UC as UPDATE_CONFIG,
)
...
def update_open_air_chicago_individual_measurements():
    update_socrata_table(update_config=UPDATE_CONFIG, conn_id=CONN_ID, task_logger=task_logger)


update_open_air_chicago_individual_measurements()
