...
from loci.sources.update_configs import (
    CHICAGO_TRAFFIC_CRASHES_PEOPLE_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["socrata", "update", "chicago", "traffic", "crashes"],
)
def update_chicago_traffic_crashes_people():
    update_socrata_table(update_config=UPDATE_CONFIG, conn_id=CONN_ID, task_logger=task_logger)


update_chicago_traffic_crashes_people()
