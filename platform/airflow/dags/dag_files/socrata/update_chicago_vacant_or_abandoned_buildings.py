...
from loci.sources.update_configs import (
    CHICAGO_VACANT_ABANDONED_BUILDINGS_UC as UPDATE_CONFIG,
)
...
@dag(
    ...
    catchup=False,
    tags=["socrata", "update", "chicago", "311"],
)
def update_chicago_vacant_or_abandoned_buildings():
    update_socrata_table(update_config=UPDATE_CONFIG, conn_id=CONN_ID, task_logger=task_logger)


update_chicago_vacant_or_abandoned_buildings()
