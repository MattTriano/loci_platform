# loci_platform/platform/airflow/dags/dag_files/refresh_bike_map_denver.py
"""Refresh the Denver bike map: dbt build → export → deploy."""
...
from loci.sources.dataset_specs import DENVER_BBOX
...
ROUTABLE_ORIGIN_DEST_PAIR = ((39.7530, -104.9999), (39.7372, -104.9889))
...
def refresh_bike_map_denver():
    build_refresh_task_graph(CITY_SPEC)


refresh_bike_map_denver()
