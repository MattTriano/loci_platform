# loci_platform/platform/airflow/dags/dag_files/refresh_bike_map_boston.py
"""Refresh the Boston bike map: dbt build → export → deploy."""
...
from loci.sources.dataset_specs import BOSTON_BBOX
...
ROUTABLE_ORIGIN_DEST_PAIR = ((42.3597, -71.0921), (42.3511, -71.0553))
...
def refresh_bike_map_boston():
    build_refresh_task_graph(CITY_SPEC)


refresh_bike_map_boston()
