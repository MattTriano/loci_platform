# loci_platform/platform/airflow/dags/dag_files/refresh_bike_map_toronto.py
"""Refresh the Toronto bike map: dbt build → export → deploy."""
...
from loci.sources.dataset_specs import TORONTO_BBOX
...
ROUTABLE_ORIGIN_DEST_PAIR = ((43.6425, -79.3867), (43.6676, -79.3947))
...
def refresh_bike_map_toronto():
    build_refresh_task_graph(CITY_SPEC)


refresh_bike_map_toronto()
