...
from loci.sources.update_configs import AHRQ_HOSPITAL_LINKAGE_UC as UPDATE_CONFIG
...
def update_ahrq_chsp_hospital_linkage():
...
update_ahrq_chsp_hospital_linkage()
