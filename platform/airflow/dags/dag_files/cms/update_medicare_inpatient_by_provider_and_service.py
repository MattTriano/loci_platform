...
from loci.sources.update_configs import (
    MEDICARE_INPATIENT_BY_PROVIDER_AND_SERVICE_UC as UPDATE_CONFIG,
)
...
def update_medicare_inpatient_by_provider_and_service():
    update_cms_table(
        conn_id=CONN_ID,
...
update_medicare_inpatient_by_provider_and_service()
